#[test_only]
module fountain::test_update_flow_rate {
    ...
    use fountain::test_utils as ftu;
    use fountain::test_lp::TEST_LP;
    use fountain::fountain_core::{Self as fc, Fountain, StakeProof, AdminCap};
